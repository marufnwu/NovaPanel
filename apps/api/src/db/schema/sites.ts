...
export const sites = sqliteTable('sites', {
  ...
  deployOnPush: integer('deploy_on_push', { mode: 'boolean' }).default(false).notNull(),
  deployOnPr: integer('deploy_on_pr', { mode: 'boolean' }).default(false).notNull(),
  autoRollback: integer('auto_rollback', { mode: 'boolean' }).default(true).notNull(),
  preDeployHook: text('pre_deploy_hook'),
  postDeployHook: text('post_deploy_hook'),
  deployPath: text('deploy_path').default('/var/www/html'),
  gitCredentials: text('git_credentials', { mode: 'json' }),
